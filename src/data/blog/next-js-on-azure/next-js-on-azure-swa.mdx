...
#### YAML
Here is an example [yaml](https://github.com/canary-ops/blog/blob/main/src/data/workflows/swa-main.yml) based on the main workflow for this blog.
...
#### YAML
Here is an example [yaml](https://github.com/canary-ops/blog/blob/main/src/data/workflows/swa-pr.yml) based on the PR workflow for this blog.
